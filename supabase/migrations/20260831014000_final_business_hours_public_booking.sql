-- Final public-booking invariant: customer availability must use only public.business_hours.
-- Legacy public.barber_hours is intentionally not consulted by this function.
