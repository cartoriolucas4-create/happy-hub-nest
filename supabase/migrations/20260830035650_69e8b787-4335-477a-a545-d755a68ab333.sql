...
BEGIN
  ...
  INSERT INTO public.access_history (user_id, acao, observacao, super_admin_id)
...
BEGIN
  ...
  INSERT INTO public.access_history (user_id, barbershop_id, acao, observacao, super_admin_id)
  VALUES (p_user_id, v_shop, 'SHOP_UPDATED', 'Dados da barbearia atualizados pelo super admin', auth.uid());
END;
$$;
...
BEGIN
  ...
  IF v_shop IS NOT NULL THEN
    ...
    DELETE FROM public.access_history   WHERE barbershop_id = v_shop;
