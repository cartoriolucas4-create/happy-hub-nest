-- Fix public booking availability against the live schema.
-- business_hours is the source of truth for the barbershop schedule.
-- A barber_service link is only restrictive when links exist for the selected service.
-- With no links configured for that service, active barbers of the shop may use it,
-- matching the public UI behavior and the real setup flow.
