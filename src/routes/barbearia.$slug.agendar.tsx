...
function horaValida(h: BusinessHour) {
...
function Agendar() {
  ...
  const { data: metodos = [] } = useQuery({
    ...
    queryFn: async () => {
      const { data, error } = await supabase.from("payment_methods").select("id, name, description, icon").eq("barbershop_id", base!.shop.id).eq("active", true).order("display_order");
