...
function MeuLink() {
  ...
  return <AdminShell title="Meu link" subtitle="Divulgue no Instagram, WhatsApp e Google">
    {!shop || !status ? <p>Carregando...</p> : !status.completo ? <div className="max-w-2xl rounded-lg border border-primary/40 bg-primary/5 p-6">
      <div className="flex items-start gap-3"><AlertTriangle className="mt-0.5 h-5 w-5 text-primary"/><div><h2 className="font-display text-sm tracking-widest">SEU SITE AINDA NÃO ESTÁ PRONTO</h2><p className="mt-2 text-sm text-muted-foreground">Complete a configuração inicial antes de compartilhar seu link.</p></div></div>
