            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <div className="mt-4 flex flex-col items-start gap-4">
                <div className="relative">
                  ...
                  {logoPreview && <button type="button" aria-label="Remover logo" title="Remover logo" onClick={() => removerImagem("logo")} className="absolute -right-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full border border-border bg-background text-muted-foreground shadow-sm transition hover:border-destructive hover:text-destructive"><X className="h-4 w-4" aria-hidden="true" /></button>}
                </div>
            ...
            <div className="rounded-xl border border-border bg-card p-5">
              ...
              <div className="mt-4 space-y-4">
                <div className="relative">
                  ...
                  {coverPreview && <button type="button" aria-label="Remover capa" title="Remover capa" onClick={() => removerImagem("capa")} className="absolute -right-2 -top-2 flex h-7 w-7 items-center justify-center rounded-full border border-border bg-background text-muted-foreground shadow-sm transition hover:border-destructive hover:text-destructive"><X className="h-4 w-4" aria-hidden="true" /></button>}
                </div>
