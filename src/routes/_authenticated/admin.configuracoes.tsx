...
const DEFAULT_PAGE_COLOR = "#1b1714";
...
function Configuracoes() {
  ...
  const selectedPageColor = form.cor_secundaria || DEFAULT_PAGE_COLOR;
  const selectedPageOption = PAGE_COLOR_OPTIONS.find((option) => option.value === selectedPageColor) ?? PAGE_COLOR_OPTIONS[0]!;
