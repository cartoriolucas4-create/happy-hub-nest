...
// This file is generated by TanStack Router. It is kept in sync with the file-based routes.
...
import { Route as AuthenticatedAdminVendasExternasRouteImport } from './routes/_authenticated/admin.vendas-externas'
...
const AuthenticatedAdminIndexRoute = AuthenticatedAdminIndexRouteImport.update({ id: '/admin/', path: '/admin/', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminAgendaRoute = AuthenticatedAdminAgendaRouteImport.update({ id: '/admin/agenda', path: '/admin/agenda', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminAgendamentosRoute = AuthenticatedAdminAgendamentosRouteImport.update({ id: '/admin/agendamentos', path: '/admin/agendamentos', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminBarbeirosRoute = AuthenticatedAdminBarbeirosRouteImport.update({ id: '/admin/barbeiros', path: '/admin/barbeiros', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminBloqueiosRoute = AuthenticatedAdminBloqueiosRouteImport.update({ id: '/admin/bloqueios', path: '/admin/bloqueios', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminClientesRoute = AuthenticatedAdminClientesRouteImport.update({ id: '/admin/clientes', path: '/admin/clientes', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminConfiguracoesRoute = AuthenticatedAdminConfiguracoesRouteImport.update({ id: '/admin/configuracoes', path: '/admin/configuracoes', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminConfigurarRoute = AuthenticatedAdminConfigurarRouteImport.update({ id: '/admin/configurar', path: '/admin/configurar', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminCustosRoute = AuthenticatedAdminCustosRouteImport.update({ id: '/admin/custos', path: '/admin/custos', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminGaleriaRoute = AuthenticatedAdminGaleriaRouteImport.update({ id: '/admin/galeria', path: '/admin/galeria', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminMeuLinkRoute = AuthenticatedAdminMeuLinkRouteImport.update({ id: '/admin/meu-link', path: '/admin/meu-link', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminPagamentosRoute = AuthenticatedAdminPagamentosRouteImport.update({ id: '/admin/pagamentos', path: '/admin/pagamentos', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminServicosRoute = AuthenticatedAdminServicosRouteImport.update({ id: '/admin/servicos', path: '/admin/servicos', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedAdminVendasExternasRoute = AuthenticatedAdminVendasExternasRouteImport.update({ id: '/admin/vendas-externas', path: '/admin/vendas-externas', getParentRoute: () => AuthenticatedRouteRoute } as any)
...
const SlugAgendarRoute = SlugAgendarRouteImport.update({ id: '/$slug/agendar', path: '/$slug/agendar', getParentRoute: () => rootRouteImport } as any)
const AuthenticatedSuperAdminClientesIndexRoute = AuthenticatedSuperAdminClientesIndexRouteImport.update({ id: '/super-admin/clientes/', path: '/super-admin/clientes/', getParentRoute: () => AuthenticatedRouteRoute } as any)
const AuthenticatedSuperAdminClientesIdRoute = AuthenticatedSuperAdminClientesIdRouteImport.update({ id: '/super-admin/clientes/$id', path: '/super-admin/clientes/$id', getParentRoute: () => AuthenticatedRouteRoute } as any)
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/admin/': { id: '/_authenticated/admin/'; path: '/admin'; fullPath: '/admin/'; preLoaderRoute: typeof AuthenticatedAdminIndexRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/agenda': { id: '/_authenticated/admin/agenda'; path: '/admin/agenda'; fullPath: '/admin/agenda'; preLoaderRoute: typeof AuthenticatedAdminAgendaRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/agendamentos': { id: '/_authenticated/admin/agendamentos'; path: '/admin/agendamentos'; fullPath: '/admin/agendamentos'; preLoaderRoute: typeof AuthenticatedAdminAgendamentosRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/barbeiros': { id: '/_authenticated/admin/barbeiros'; path: '/admin/barbeiros'; fullPath: '/admin/barbeiros'; preLoaderRoute: typeof AuthenticatedAdminBarbeirosRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/bloqueios': { id: '/_authenticated/admin/bloqueios'; path: '/admin/bloqueios'; fullPath: '/admin/bloqueios'; preLoaderRoute: typeof AuthenticatedAdminBloqueiosRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/clientes': { id: '/_authenticated/admin/clientes'; path: '/admin/clientes'; fullPath: '/admin/clientes'; preLoaderRoute: typeof AuthenticatedAdminClientesRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/configuracoes': { id: '/_authenticated/admin/configuracoes'; path: '/admin/configuracoes'; fullPath: '/admin/configuracoes'; preLoaderRoute: typeof AuthenticatedAdminConfiguracoesRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/configurar': { id: '/_authenticated/admin/configurar'; path: '/admin/configurar'; fullPath: '/admin/configurar'; preLoaderRoute: typeof AuthenticatedAdminConfigurarRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/custos': { id: '/_authenticated/admin/custos'; path: '/admin/custos'; fullPath: '/admin/custos'; preLoaderRoute: typeof AuthenticatedAdminCustosRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/galeria': { id: '/_authenticated/admin/galeria'; path: '/admin/galeria'; fullPath: '/admin/galeria'; preLoaderRoute: typeof AuthenticatedAdminGaleriaRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/meu-link': { id: '/_authenticated/admin/meu-link'; path: '/admin/meu-link'; fullPath: '/admin/meu-link'; preLoaderRoute: typeof AuthenticatedAdminMeuLinkRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/pagamentos': { id: '/_authenticated/admin/pagamentos'; path: '/admin/pagamentos'; fullPath: '/admin/pagamentos'; preLoaderRoute: typeof AuthenticatedAdminPagamentosRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/servicos': { id: '/_authenticated/admin/servicos'; path: '/admin/servicos'; fullPath: '/admin/servicos'; preLoaderRoute: typeof AuthenticatedAdminServicosRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/admin/vendas-externas': { id: '/_authenticated/admin/vendas-externas'; path: '/admin/vendas-externas'; fullPath: '/admin/vendas-externas'; preLoaderRoute: typeof AuthenticatedAdminVendasExternasRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    ...
    '/$slug/agendar': { id: '/$slug/agendar'; path: '/$slug/agendar'; fullPath: '/$slug/agendar'; preLoaderRoute: typeof SlugAgendarRouteImport; parentRoute: typeof rootRouteImport }
    '/_authenticated/super-admin/clientes/': { id: '/_authenticated/super-admin/clientes/'; path: '/super-admin/clientes'; fullPath: '/super-admin/clientes/'; preLoaderRoute: typeof AuthenticatedSuperAdminClientesIndexRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
    '/_authenticated/super-admin/clientes/$id': { id: '/_authenticated/super-admin/clientes/$id'; path: '/super-admin/clientes/$id'; fullPath: '/super-admin/clientes/$id'; preLoaderRoute: typeof AuthenticatedSuperAdminClientesIdRouteImport; parentRoute: typeof AuthenticatedRouteRoute }
  }
}
...
const AuthenticatedRouteRouteChildren: AuthenticatedRouteRouteChildren = {
  AuthenticatedAdminAgendaRoute,
  AuthenticatedAdminAgendamentosRoute,
  AuthenticatedAdminBarbeirosRoute,
  AuthenticatedAdminBloqueiosRoute,
  AuthenticatedAdminClientesRoute,
  AuthenticatedAdminConfiguracoesRoute,
  AuthenticatedAdminConfigurarRoute,
  AuthenticatedAdminCustosRoute,
  AuthenticatedAdminGaleriaRoute,
  AuthenticatedAdminMeuLinkRoute,
  AuthenticatedAdminPagamentosRoute,
  AuthenticatedAdminServicosRoute,
...
const rootRouteChildren: RootRouteChildren = {
  ...
  LoginRoute,
  ResetPasswordRoute,
  BarbeariaSlugAgendarRoute,
  BarbeariaSlugIndexRoute,
  SlugAgendarRoute,
  SlugIndexRoute,
}
